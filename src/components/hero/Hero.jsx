        ...
        <div className=" left mt-4 md:mt-0 flex-1 flex flex-col justify-center gap-5 w-1/2 md:w-full md:py-2 sm:py-0">
          <div className="info w-fit flex flex-col items-start justify-center gap-3 sm:gap-2">
            ...
            >
              ...
              <span className="text-black">Amit Saini</span>
            </h2>
            <TypeAnimation
              data-aos="fade-up"
              sequence={[
          ...
          <div className="icons flex mt-5">
            ...
            >
              <li>
                <a
                  href="https://github.com/1sainiamit?tab=repositories"
                  target="_blank"
                >
                  {" "}
              ...
              <li>
                <a href="https://www.linkedin.com/in/sainiamit01/">
                  {" "}
                  <FaLinkedinIn className=" h-[1.8rem] w-[1.8rem] text-xl hover:scale-125 hover:text-white" />{" "}
                </a>
              </li>
              <li>
                <a href="https://twitter.com/isainiamit" target="_blank">
                  {" "}
